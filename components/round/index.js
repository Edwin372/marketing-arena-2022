        ...
        return (
            <div id="round" className="session">
                ...
                <Image
                    ...
                    layout={'raw'}
                />
                <p className={'round-structure-text'}>
                ...
                <div className={'round-structure'}>
                    ...
                    <Image priority={true} src={roundItem} layout={'raw'} id={`r`} className={'round-item'}/>
                    <Image priority={true} src={roundItem1} layout={'raw'} id={`r1`} className={'round-item'}/>
                    <Image priority={true} src={roundItem2} layout={'raw'} id={`r2`} className={'round-item'}/>
                    <Image priority={true} src={roundItem3} layout={'raw'} id={`r3`} className={'round-item'}/>
                    <Image priority={true} src={roundItem4} layout={'raw'} id={`r4`} className={'round-item'}/>
                    <Image priority={true} src={roundItem5} layout={'raw'} id={`r5`} className={'round-item'}/>
                    <Image priority={true} src={roundItem6} layout={'raw'} id={`r6`}className={'round-item'}/>
                    <Image priority={true} src={roundItem7} layout={'raw'} id={`r7`} className={'round-item'}/>
                    <Image priority={true} src={roundItem8} layout={'raw'} id={`r8`}className={'round-item'}/>
                    <div className={'row-round'}>
                        <Image src={roundItem9} layout={'raw'} id={`r9`}className={'round-item'}/>
                        <Image src={roundItem10} layout={'raw'} id={`r10`}className={'round-item'}/>
                    </div>
                    <Image src={congratChamp} layout={'raw'} id={`congrat-champ`} className={'round-item'}/>
